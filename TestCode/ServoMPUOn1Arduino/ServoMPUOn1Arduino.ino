...
void loop() {
  ...
  if (mpu.dmpGetCurrentFIFOPacket(fifoBuffer)) { // Get the Latest packet
    ...
    servoY = ypr[0] * 180 / M_PI;
    Serial.print("\t");
    Serial.print(ypr[1] * 180 / M_PI);
    servoP = ypr[1] * 180 / M_PI;
    Serial.print("\t");
    Serial.println(ypr[2] * 180 / M_PI);

    servoYmap = map(servoY, 180, 0, SERVOMIN, SERVOMAX);
    pwm.writeMicroseconds(servo0, servoYmap);
    servoPmap = map(servoP, 180, 0, SERVOMIN, SERVOMAX);
    pwm.writeMicroseconds(servo1, servoPmap);
    delay(1);
#endif
